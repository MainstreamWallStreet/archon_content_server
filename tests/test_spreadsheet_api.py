...
class TestSpreadsheetEndpoints:
    ...
    def test_generate_spreadsheet_success(self, mock_build, mock_generator_class):
        ...
        try:
            response = client.post(
                "/spreadsheet/build",
                json={
                    "objective": "Model FY-2024 revenue",
                    "data": "Revenue: 100M"
                }
            )
    ...
    @patch("src.api.PlanGenerator")
    def test_generate_spreadsheet_missing_api_key(self, mock_generator_class):
    ...
    @patch("src.api.PlanGenerator")
    def test_generate_plan_success(self, mock_generator_class):
    ...
    @patch("src.api.PlanGenerator")
    def test_generate_plan_missing_api_key(self, mock_generator_class):
